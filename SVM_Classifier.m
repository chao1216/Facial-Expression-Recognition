...
ha_dir=('/Users/chaolin/Documents/EE4830/FER/Facial-Expression-Recognition/training/happy');
sa_dir=('/Users/chaolin/Documents/EE4830/FER/Facial-Expression-Recognition/training/sad');
su_dir=('/Users/chaolin/Documents/EE4830/FER/Facial-Expression-Recognition/training/surprise');
fe_dir=('/Users/chaolin/Documents/EE4830/FER/Facial-Expression-Recognition/training/fear');
an_dir=('/Users/chaolin/Documents/EE4830/FER/Facial-Expression-Recognition/training/anger');
di_dir=('/Users/chaolin/Documents/EE4830/FER/Facial-Expression-Recognition/training/disgust');
...
HS_DUFA = fitcsvm(HS_DUFA_Training, HS_DUFA_Classes);
save HS_DUFA_classifier_2.mat HS_DUFA;

%HS = fitcecoc(HS_Training, HS_Classes);
HS = fitcsvm(HS_Training, HS_Classes);
save HS_classifier_2.mat HS;

%DU_FA = fitcecoc(DUFA_Training, DUFA_Classes);
DU_FA = fitcsvm(DUFA_Training, DUFA_Classes);
save DUFA_classifier_2.mat DU_FA;

%AD = fitcecoc(AD_Training, AD_Classes);
AD = fitcsvm(AD_Training, AD_Classes);
save AD_classifier_2.mat AD;

%UF = fitcecoc(UF_Training, UF_Classes);
UF = fitcsvm(UF_Training, UF_Classes);
save UF_classifier_2.mat UF;
